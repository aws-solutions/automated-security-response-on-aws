...
./build-s3-dist.sh -b 5pillars-playbooks -c v2.0.1.7
./build-s3-dist.sh -b 5pillars-playbooks -v v2.0.1.7
aws s3 sync ./global-s3-assets s3://5pillars-playbooks-reference/aws-security-hub-automated-response-and-remediation/latest/
aws s3 sync ./global-s3-assets s3://5pillars-playbooks-reference/aws-security-hub-automated-response-and-remediation/v2.0.1.7/ # replace this with correct versio
