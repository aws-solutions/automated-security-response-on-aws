...
./build-s3-dist.sh -b 5pillars-prod-playbooks -c v2.0.1.10
./build-s3-dist.sh -b 5pillars-prod-playbooks -v v2.0.1.10
...
aws s3 sync ./global-s3-assets s3://5pillars-prod-playbooks-reference/aws-security-hub-automated-response-and-remediation/v2.0.1.10/ # replace this with correct versio
