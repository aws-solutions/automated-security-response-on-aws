...
def run_remove_old_credentials(remediation, account, region):
    ...
    key_user_id = get_userid_from_name(key_user, region)
    test.test_json['detail']['findings'][0]['Resources'][0]['Id'] = 'arn:aws-cn:iam::111111111111:user/' + key_user
    test.test_json['detail']['findings'][0]['Resources'][0]['Details']['AwsIamUser']['UserId'] = key_user_id
