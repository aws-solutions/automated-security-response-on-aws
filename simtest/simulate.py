...
def usage():
    print('Run this after assuming role (using isengardcli) in the Security Hub Administor account. Use isengardcli credentials to get temporary credentials before running this script')
...
def create_argument_parser():
    ...
    argument_parser.add_argument(
        ...
        '-s',
        required = True,
        help = 'Security Standard (cis, afsbp, or pci)')
    argument_parser.add_argument(
        '--control',
        '-c',
        required = True,
