...
export interface AdminAccountConstructProps {
    solutionId: string;
}

export class AdminAccountParm extends cdk.Construct {

  public readonly adminAccountNumber: cdk.CfnParameter;

  constructor(scope: cdk.Construct, id: string, props: AdminAccountConstructProps) {
    super(scope, id);
