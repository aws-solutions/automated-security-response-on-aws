...
import * as apigateway_1 from '../ssmdocs/SC_APIGateway.1';
import * as apigateway_5 from '../ssmdocs/SC_APIGateway.5';
...
import * as cloudwatch_16 from '../ssmdocs/SC_CloudWatch.16';
...
import * as ec2_10 from '../ssmdocs/SC_EC2.10';
...
const controlRunbooksRecord: Record<string, any> = {
  ...
  'CloudTrail.6': cloudtrail_6.createControlRunbook,
  'CloudTrail.7': cloudtrail_7.createControlRunbook,
  'CloudWatch.1': cloudwatch_1.createControlRunbook,
  ...
  'IAM.18': iam_18.createControlRunbook,
  'IAM.22': iam_22.createControlRunbook,
