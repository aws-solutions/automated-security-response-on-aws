...
export function createControlRunbook(scope: Construct, id: string, props: PlaybookProps): ControlRunbookDocument {
  return new EnableELBDeletionProtectionDocument(scope, id, { ...props, controlId: 'ELB.6' });
}
...
export class EnableELBDeletionProtectionDocument extends ControlRunbookDocument {
  constructor(stage: Construct, id: string, props: ControlRunbookProps) {
    super(stage, id, {
      ...props,
      securityControlId: 'ELB.6',
      remediationName: 'EnableELBDeletionProtection',
