...
def test_get_metrics_from_finding(mocker):
    ...
    finding = utils.load_test_data(test_data + 'cis_1-3-iamuser1.json', my_region).get('detail').get('findings')[0]
...
def test_send_metrics(mocker):
    ...
    send_metrics = mocker.patch('lib.metrics.Metrics.post_metrics_to_api', return_value=None)
